...
export default function AdminSettingsScreen() {
  const { profile, hardSignOut } = useAuth();
  ...
  const managementItems = [
    ...
    },
    {
      icon: ShoppingCart,
      title: 'Cart Recovery',
      subtitle: 'Configure abandoned-cart reminders',
      color: '#5A2D82',
      onPress: () => router.push('/(admin)/cart-reminders'),
    },
    {
      icon: ImageIcon,
      title: 'Category Images',
      subtitle: 'Set the photo on each shop category tile',
      color: '#0EA5E9',
      onPress: () => router.push('/(admin)/category-images'),
    },
    {
      icon: MessageCircle,
      title: 'Messaging',
