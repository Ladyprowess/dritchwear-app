...
import { Users, Search, Filter, Wallet, MoreHorizontal, Eye, X, Star } from 'lucide-react-native';
...
export default function AdminUsersScreen() {
  ...
  const totalPointsBalance = users.reduce((sum, user) => sum + (user.points_balance ?? 0), 0);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={[styles.statCard, { borderTopWidth: 2, borderTopColor: '#F59E0B' }]}>
          <Text style={[styles.statValue, { color: '#D97706' }]}>{totalPointsBalance.toLocaleString()}</Text>
